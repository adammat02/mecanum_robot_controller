...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO3_Pin|GPIO2_Pin|GPIO1_Pin|TOF2_XSHUT_Pin
                          |TOF1_XSHUT_Pin|LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GPIO3_Pin GPIO2_Pin GPIO1_Pin TOF2_XSHUT_Pin
                           TOF1_XSHUT_Pin LED_Pin */
  GPIO_InitStruct.Pin = GPIO3_Pin|GPIO2_Pin|GPIO1_Pin|TOF2_XSHUT_Pin
                          |TOF1_XSHUT_Pin|LED_Pin;
